...
// File unflatten/StakingDistributor.sol
...
contract StakingDistributor is Ownable {
    ...
    constructor( address _treasury, address _fort, uint _epochLength, uint _nextEpochTime ) {
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return IERC20( FORT ).totalSupply().mul( _rate ).div( 1000000 );
    }
