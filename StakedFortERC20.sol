...
// File unflatten/StakedFortERC20.sol

pragma solidity 0.7.5;


contract StakedFortERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("StakedFORT", "sFORT", 9) ERC20Permit() {
        initializer = msg.sender;
        _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
    }

    function initialize( address stakingContract_ ) external onlyOwner() returns ( bool ) {
